1  TEXT : CALL  - 936
5  GOSUB 19000: GOSUB 10000: GOSUB 11000: GOSUB 16000: GOTO 135
...
95  REM     V.5 BY JIM GERBER
99  REM 
100  REM LIGHTNING FLASHES
101  COLOR= 15: IF  RND (K1) > KP THEN 110
102 X =  RND (K1) * K5 + K8:Y = 5:I =  RND (K1) * K4 + K7: VLIN Y,I AT X
104  FOR J = 1 TO 6:Y = I + K1:I = I + K3 +  RND (K1) * K5:X = X + K1 - K2 * ( RND (K1) > KP): IF I > KTP AND X > KL THEN X = X - K2
106  IF I > KB THEN 120
108  IF I < KB THEN  VLIN Y,I AT X: NEXT : RETURN 
110 X =  RND (K1) * K8 + 26:Y = K7:I =  RND (K1) * K5 + K7: VLIN Y,I AT X
112 Y = I + K1:I = I + K3 +  RND (K1) * K5:X = X + K1 - K2 * ( RND (K1) > KP): IF X < KR THEN X = X + K2
114  IF I > KB THEN 120
116  VLIN Y,I AT X: GOTO 112
120  RETURN 
...
875  PRINT "FOR YOU TO MAKE.": GOSUB 18000: GOTO 1100
890  PRINT "HOW MANY GLASSES OF LEMONADE DO YOU"
895  PRINT "WISH TO MAKE ";
900  INPUT IN$:L(I) =  VAL (IN$)
...
1060  IF  LEFT$ (A$,1) = "Y" OR  LEFT$ (A$,1) = "y" THEN  HOME :C5 = 1: GOTO 820
1100  HOME 
1101  NEXT I
1110 C5 = 0: TEXT : HOME 
...
1327  VTAB 5: CALL  - 958: GOTO 1390
1330  GOSUB 5000
...
2296  FOR DE = 1 TO 1000: NEXT DE: VTAB 3: CALL  - 958
2297  GOTO 1185
...
5070  REM  
5090  HOME : RETURN 
7004  FOR J = 1 TO 6:Y = I + K1:I = I + K3 +  RND (K1) * K5:X = X + K1 - K2 * ( RND (K1) > KP): IF I > KTP AND X > KL THEN X = X - K2
10000  REM   INITIALIZE
10010  IN# 0: PR# 0
10015  REM  POKE 770,SOP SETS SOUND OPTION
10100  POKE 770,SOP: POKE 771,48: POKE 772,192: POKE 773,136: POKE 774,208: POKE 775,5: POKE 776,206: POKE 777,1: POKE 778,3: POKE 779,240: POKE 780,9: POKE 781,202
...
10210 I = K1 = X = Y:K1 = 1:KP = .5:K5 = 5:KB = 25:K2 = 2:K3 = 3:K4 = 4:K5 = 5:K7 = 7:KR = 27:K8 = 8:KT = 13:KL = 14:K6 = 6:K9 = 9
10999  RETURN 
...
11280  VTAB 23: PRINT "COPYRIGHT 1979,1984 APPLE COMPUTER INC."
11300  GOSUB 11700: FOR I = 1 TO 200: IF  PEEK ( - 16384) = 141 OR  PEEK ( - 16384) = 160 THEN I = 200
11305  NEXT 
...
11365  FOR J = 1 TO 5: IF  PEEK ( - 16384) = 141 OR  PEEK ( - 16384) = 160 THEN J = 5
11370  NEXT : POKE 768,I * 3 - 12: POKE 769,12: CALL 770
11371  NEXT : COLOR= 12: VLIN 14,19 AT 12
11400  POKE 32,0: POKE 33,40: POKE 34,20: POKE 35,23: VTAB 22
11410  FOR I = 1 TO 400: IF  PEEK ( - 16384) = 141 OR  PEEK ( - 16384) = 160 THEN I = 400
11420  NEXT I:I =  FRE (0)
11430  POKE  - 16368,0
11490  RETURN 
11500  REM   DATA
...
12115  FOR I = 1 TO 10:J =  RND (1) * 25 + 50: POKE 768,J: POKE 769,10: CALL 770: NEXT 
...
12200  VTAB 21: CALL  - 958: INPUT "TYPE YOUR ANSWER AND PRESS RETURN ==> ";A$
12210 A$ =  LEFT$ (A$,1): IF A$ <  > "Y" AND A$ <  > "N" AND A$ <  > "y" AND A$ <  > "n" THEN  PRINT  CHR$ (7);: GOTO 12200
...
14160 A$ =  LEFT$ (A$,1): IF A$ = "Y" OR A$ = "y" THEN  PRINT "GOOD!  WHAT DAY WAS IT? ";:I = I + 1: GOTO 14150
14170  IF A$ = "N" OR A$ = "n" OR I > 0 THEN 14300
...
15120  COLOR= 12: IF SC = 5 THEN  COLOR= 4
15125  FOR I = 26 TO 39: HLIN 0,39 AT I: NEXT I
15130  COLOR= 8: FOR I = 24 TO 32: HLIN 15,25 AT I: NEXT I: HLIN 15,25 AT 14: VLIN 14,23 AT 15: VLIN 14,23 AT 25
...
15158  HLIN 6,10 AT 2: HLIN 4,14 AT 3: HLIN 7,12 AT 4: HLIN 22,30 AT 4: HLIN 20,36 AT 5: HLIN 23,33 AT 6: IF SC = 5 THEN  GOSUB 17000
15159  GOTO 15170
...
15510 I =  FRE (0): FOR I = 1 TO 200: IF  PEEK ( - 16384) = 141 OR  PEEK ( - 16384) = 160 THEN I = 200
15520  NEXT I: POKE  - 16368,0: RETURN 
16000  REM COLOR CHANGE ROUTINE
16010  REM COPYRIGHT 1978 BY
16020  REM BRUCE TOGNAZZINI
16030  REM ALL RIGHTS RESERVED
16035  POKE 800,76: POKE 801,140: POKE 802,3: POKE 803,165: POKE 804,48: POKE 805,41: POKE 806,15: POKE 807,141: POKE 808,192: POKE 809,3: POKE 810,165: POKE 811,48: POKE 812,41
16040  POKE 813,240: POKE 814,141: POKE 815,193: POKE 816,3: POKE 817,165: POKE 818,36: POKE 819,141: POKE 820,194: POKE 821,3: POKE 822,165: POKE 823,37: POKE 824,141: POKE 825,195:
16050  POKE 826,3: POKE 827,169: POKE 828,0: POKE 829,133: POKE 830,36: POKE 831,133: POKE 832,37: POKE 833,72: POKE 834,32: POKE 835,193: POKE 836,251: POKE 837,133: POKE 838,40:
16060  POKE 839,164: POKE 840,36: POKE 841,177: POKE 842,40: POKE 843,41: POKE 844,15: POKE 845,205: POKE 846,196: POKE 847,3: POKE 848,208: POKE 849,10: POKE 850,177: POKE 851,40:
16070  POKE 852,41: POKE 853,240: POKE 854,24: POKE 855,109: POKE 856,192: POKE 857,3: POKE 858,145: POKE 859,40: POKE 860,177: POKE 861,40: POKE 862,41: POKE 863,240: POKE 864,205:
16080  POKE 865,197: POKE 866,3: POKE 867,208: POKE 868,10: POKE 869,177: POKE 870,40: POKE 871,41: POKE 872,15: POKE 873,24: POKE 874,109: POKE 875,193: POKE 876,3: POKE 877,145:
16090  POKE 878,40: POKE 879,200: POKE 880,192: POKE 881,40: POKE 882,144: POKE 883,213: POKE 884,160: POKE 885,0: POKE 886,104: POKE 887,105: POKE 888,0: POKE 889,197: POKE 890,34:
16100  POKE 891,144: POKE 892,196: POKE 893,32: POKE 894,193: POKE 895,251: POKE 896,133: POKE 897,40: POKE 898,173: POKE 899,162: POKE 900,48: POKE 901,133: POKE 902,36: POKE 903,173:
16110  POKE 904,195: POKE 905,3: POKE 906,133: POKE 907,37: POKE 908,165: POKE 909,48: POKE 910,41: POKE 911,15: POKE 912,141: POKE 913,196: POKE 914,3: POKE 915,165: POKE 916,48:
16120  POKE 917,41: POKE 918,240: POKE 919,141: POKE 920,197: POKE 921,3: POKE 922,96:
16130  RETURN 
17000  FOR LIGHTNING = 1 TO 2: GOSUB 100
17020  FOR RPT = 1 TO 5
17040  COLOR= 4: CALL 800: COLOR= 12: CALL 803
17050  COLOR= 15: CALL 800: COLOR= 9: CALL 803: COLOR= 15: CALL 803
17054  COLOR= 12: CALL 800: COLOR= 4: CALL 803
17060  NEXT 
17070  COLOR= 15: CALL 800: COLOR= 5: CALL 803: NEXT 
17090  RETURN 
17104  FOR J = 1 TO 6:Y = I + K1:I = I + K3 +  RND (K1) * K5:X = X + K1 - K2 * ( RND (K1) > KP): IF I > KTP AND X > KL THEN X = X - K2
18000  VTAB 24: PRINT " PRESS SPACE TO CONTINUE, ESC TO END...";
18005  POKE  - 16368,0
18010  GET IN$: IF IN$ <  > " " AND  ASC (IN$) <  > 27 AND  ASC (IN$) <  > 13 THEN 18010
18020  IF  ASC (IN$) <  > 27 THEN  RETURN 
18021  HOME : VTAB 8: PRINT "ARE YOU SURE YOU WANT TO QUIT ?";
18022  GET IN$
18023  IF IN$ = "Y" OR IN$ = "y" THEN 31111
18024  RETURN 
18030  RETURN 
19000  REM  SOUND OPTION
19010 SOP = 173
19020  HOME : VTAB 10: INPUT "DO YOU WANT SOUND? (YES/NO) ";J$
19030  IF  LEN (J$) = 0 THEN 19050
19040  IF  ASC (J$) =  ASC ("Y") OR  ASC (J$) =  ASC ("y") THEN 19050
19045  IF  ASC (J$) <  >  ASC ("n") AND  ASC (J$) <  >  ASC ("N") THEN 19020
19048 SOP = 96
19050  RETURN 
31111  HOME 
...
31136  POKE  - 16368,0: IF  PEEK (1020) =  INT (SERIAL / 256) AND  PEEK (1021) = SERIAL - ( INT (SERIAL / 256) * 256) AND  PEEK (1019) = 0 THEN 31156
31146  TEXT : CALL  - 936: TEXT : END 
31156  POKE 1020,0: POKE 1021,0: PRINT : PRINT "RUN INDEX": END 
